...
char uart_buffer[25];  // UART buffer for printing data

#define ADC_MAX_VALUE 4095
#define LED_MAX_BRIGHTNESS 255
#define CADENCE_SENSOR_THRESHOLD 2000  //threshold for detecting magnet passing
...
void Print_ADC_Values(void) {
    snprintf(uart_buffer, sizeof(uart_buffer), "ADC PA1=%lu, PA2=%lu, PA4=%lu, PA5=%lu, PAS=%lu\r\n",
...
int main(void) {
  ...
  while (1)
  {
    ...
    Calculate_PAS();
    Print_ADC_Values();
    HAL_Delay(100);  // Adjust delay as needed for real-time performance
    /* USER CODE END WHILE */
